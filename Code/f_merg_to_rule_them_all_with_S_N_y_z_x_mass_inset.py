...
for S_N in centers_S_N:
    ...
    for z in centers_z:#, axs.ravel()):
        ...
        x = df_fmerg[(df_fmerg['z'] == z) & (df_fmerg['S/N'] == S_N) & (df_fmerg['count'] > count_threshhold)]['mass'].values
        ...
        X = df_fmerg[(df_fmerg['z'] == z) & (df_fmerg['S/N'] == S_N) & (df_fmerg['count'] > count_threshhold)]['mass']
        ...
        axs[count_y,count_x].set_xlim([9.5,12.5])
