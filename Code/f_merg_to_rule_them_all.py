...
table_name = '../Tables/f_merg_'+str(run)+'_'+str(suffix)+'_mass_bins_'+str(nbins_mass)+'_'+str(add_on_binned_table)+'.csv'
...
if save_df:
	...
	if len(list_of_prior_files) ==0:
		...
		name_single = '../Tables/LDA_out_all_SDSS_predictors_'+str(run)+'_flags.txt'
...
# Do a 2D regression:
X = df_fmerg[['mass', 'z', 'S/N','B/T','count']] 
